...
function d3ptree() {
    ...
    function link(scope, el, att) {
        ...
        function init(newData) {
            ...
            rootNodeIndex = (scope.rootNodeIndex > -1) ? scope.rootNodeIndex : -1;
        ...
        function initData(model) {
            ...
            if (Array.isArray(treeModel)) {
                graphRoot = (treeModel.length > 0) ? treeModel[rootNodeIndex] : {};
            }
            else {
                graphRoot = treeModel;
            }
        ...
        function update(source) {
                        ...
                        switch (d.valueType) {
                            ...
                            case 2:
                                if (d.value && typeof d.value === "string") {
                                    ret = (d.value.length > 15) ? "String to long..." : d.value;
                                }
                                else {
                                    ret = d.value;
                                }
            ...
            nodeEnter
                ...
                .style("stroke", function (d) {
                    return (d.valueType == 2) ? "red" : null;
                })
                .style("stroke-width", function (d) {
                    return (d.valueType == 2) ? 2 : null;
                })
                .attr("width", function (d) {
                    return d._textNode.getComputedTextLength() + 16;
                })
                .attr("height", "24")
                .attr("y", "-12")
                .attr("rx", 4)
