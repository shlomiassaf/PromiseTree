;(function(context, name, definition) {
  ...
  var counter = 0;
  var roots = {};
  var debug = debug = function() {}; //console.log;
  ...
  PromiseWrapper.wrapCallbackWithHint = function(cb, parentHint) {
    return function() {
      ...
      return function(){ return cb.apply(this, cbArgs);}.apply(this, [null, null, verificationMatchRef, parentHint]);
    };
  };
